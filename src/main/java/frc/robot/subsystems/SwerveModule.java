...
public class SwerveModule {
    ...
    private void configAngleEncoder(){        
        ...
        angleEncoder.configAllSettings(CTREConfigs.getConfigs().swerveCanCoderConfig);
    }

    private void configAngleMotor(){
        mAngleMotor.configFactoryDefault();
        mAngleMotor.configAllSettings(CTREConfigs.getConfigs().swerveAngleFXConfig);
    ...
    private void configDriveMotor(){        
        ...
        mDriveMotor.configAllSettings(CTREConfigs.getConfigs().swerveDriveFXConfig);
